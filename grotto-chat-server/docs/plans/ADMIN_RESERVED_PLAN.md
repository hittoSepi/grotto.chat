...
**Status:** Design Phase  
**Target:** grotto-server v0.2.0  
**Related:** grotto-server-tui (admin interface)
...
- Is controlled via grotto-server-tui interface
...
│                                                                  │
│  ┌──────────────────┐      ┌─────────────────────────────────┐ │
│  │ grotto-server    │      │ ServerOwner (reserved identity) │ │
│  │     (TUI)        │◄────►│                                 │ │
...
## 6. grotto-server-tui Integration

### 6.1 TUI as Admin Interface

```
┌─────────────────────────────────────────────────────────────┐
│  Grotto Server Admin (TUI)                                   │
├─────────────────────────────────────────────────────────────┤
...
tui_unix_socket = "/run/grotto/admin.sock"
...
- grotto-server-tui architecture
