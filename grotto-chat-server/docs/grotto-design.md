...
**Grotto** on TUI-pohjainen (ncurses) chat- ja VoIP-sovellus, joka yhdistää
...
| Komponentti | Rooli |
|---|---|
| **grotto-server** | Relay, key distribution, presence, STUN/TURN, offline store |
| **grotto-client** | ncurses TUI, Signal Protocol session mgmt, voice engine |
| **grotto-proto** | Shared protobuf/flatbuffers message definitions |
