...
# motd = "Welcome to Grotto!"
# motd = ["Welcome to Grotto!", "Please read the rules."]
motd = ""
...
struct ServerConfig {
    ...
    std::string directory_url = "https://directory.grotto.dev";  // Directory service URL
    ...
    std::string admin_tui_socket = "/run/grotto/admin.sock";  // TUI unix socket path
};
