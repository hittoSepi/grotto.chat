...
namespace grotto::db { class UserStore; class OfflineStore; class Database; class FileStore; }
namespace grotto::commands { class CommandHandler; }
...
private:
    ...
    void handle_read_receipt(const ReadReceipt& receipt, const Envelope& raw);
