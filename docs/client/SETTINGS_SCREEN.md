...
## Overview
This document describes the settings screen implementation for the Grotto desktop client.
...
- Windows: `%APPDATA%\grotto\config.toml`
- Linux: `~/.config/grotto/config.toml`
