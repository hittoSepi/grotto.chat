...
// Uses libsignal-protocol-c's group_session_builder and group_cipher.
class GroupSession {
public:
    ...
    // This must be called before encrypting messages to a channel.
    ...
    // Returns a SenderKeyMessage that can be sent to the group.
