...
const std::unordered_map<I18nKey, std::string> kEnglish = {
    ...
    {I18nKey::VOICE_PTT_HOTKEY_LABEL, "Talk Hotkey: "},
    {I18nKey::VOICE_VAD_THRESHOLD_LABEL, "VAD Threshold: "},
    {I18nKey::VOICE_SYSTEM_DEFAULT, "System default"},
    {I18nKey::VOICE_MODE_TOGGLE, "Toggle to Talk"},
    {I18nKey::VOICE_MODE_PTT, "Push to Talk"},
    ...
    {I18nKey::VOICE_PTT_CAPTURE_TITLE, "Set Talk Hotkey"},
    ...
    {I18nKey::AUTH_FAILED_IDENTITY_PASSWORD_MISMATCH, "Local identity does not match the server record, and the recovery passkey was incorrect. Use the original passkey or press CLEAR CREDS."},
    {I18nKey::AUTH_FAILED_IDENTITY_RECOVERY_REQUIRED, "Local identity does not match the server record. Set a recovery password with /password on a successful login before using key recovery."},
...
const std::unordered_map<I18nKey, std::string> kFinnish = {
    ...
    {I18nKey::VOICE_PTT_CAPTURE_TITLE, "Aseta puhepainike"},
    ...
    {I18nKey::AUTH_FAILED_IDENTITY_PASSWORD_MISMATCH, "Paikallinen identiteetti ei vastaa palvelimen tietuetta, ja palautussalasana oli väärä. Käytä alkuperäistä salasanaa tai paina TYHJENNÄ."},
    {I18nKey::AUTH_FAILED_IDENTITY_RECOVERY_REQUIRED, "Paikallinen identiteetti ei vastaa palvelimen tietuetta. Aseta palautussalasana komennolla /password onnistuneen kirjautumisen jälkeen ennen avainpalautuksen käyttöä."},
