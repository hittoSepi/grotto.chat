...
const std::unordered_map<I18nKey, std::string> kEnglish = {
    ...
    {I18nKey::VOICE_NOISE_SUPPRESSION_LEVEL_LABEL, "NS Level: "},
    ...
    {I18nKey::VOICE_NS_LEVEL_LOW, "Low"},
    {I18nKey::VOICE_NS_LEVEL_MODERATE, "Moderate"},
    {I18nKey::VOICE_NS_LEVEL_HIGH, "High"},
    {I18nKey::VOICE_NS_LEVEL_VERY_HIGH, "Very High"},
...
const std::unordered_map<I18nKey, std::string> kFinnish = {
    ...
    {I18nKey::VOICE_NOISE_SUPPRESSION_LEVEL_LABEL, "Kohinanvaimennuksen taso: "},
    ...
    {I18nKey::VOICE_NS_LEVEL_LOW, "Matala"},
    {I18nKey::VOICE_NS_LEVEL_MODERATE, "Kohtalainen"},
    {I18nKey::VOICE_NS_LEVEL_HIGH, "Korkea"},
    {I18nKey::VOICE_NS_LEVEL_VERY_HIGH, "Erittäin korkea"},
    ...
    {I18nKey::VOICE_SELF_TEST_ACTIVE, "kaynnissa"},
    {I18nKey::VOICE_SELF_TEST_INACTIVE, "pysaytetty"},
