IRCord – Installer Planning Handover
...
'------------------------------------------'
   Server name:      ircord.local
   Listen address:   0.0.0.0
   Port:             6697
   Data directory:   /opt/ircord/data
...
IRCord installed successfully

Server port: 6697
Config: /opt/ircord/config.json
Logs:   /opt/ircord/logs

Docs: https://chat.rausku.com/docs
...
Create minimal functional installer prototype.
...
IRCord is not trying to be Discord.
...
https://chat.rausku.com/docs/index.html
End of handover

Next discussion should focus on:

implementing the installer

defining install steps

creating the FTXUI wizard structure.
