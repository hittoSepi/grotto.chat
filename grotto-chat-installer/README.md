...
Linux-first stage-2 installer for Grotto server. It provides a terminal wizard built with FTXUI and installs a prebuilt `grotto-server` binary instead of compiling from source.
...
```bash
./grotto-installer --manifest-file ./installer-manifest.example.json
```
...
- `https://chat.rausku.com/downloads/grotto-installer-linux-x64`
- `https://chat.rausku.com/downloads/grotto-installer-linux-arm64`
